...
class FoldersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create folder" do
    assert_difference('Folder.count') do
      post folders_url, params: { folder: { title: @folder.title, user_id: @folder.user_id } }, as: :json
    end
  ...
  test "should update folder" do
    patch folder_url(@folder), params: { folder: { title: @folder.title, user_id: @folder.user_id } }, as: :json
    assert_response 200
  end
